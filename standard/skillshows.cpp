...
/* skill, level, desc */
  ...
  { S_WEAPONSMITH, 4,
    "A unit with "
    "this skill may use the PRODUCE order "
    " to produce magic crossbows from ironwood. Production can be increased "
    " by using axes. A magic crossbow fires as if the target has a "
    " defensive skill of 0, and fires one shot per round. It takes one "
    "unit of ironwood to produce a magic crossbow, which weighs one unit." },
  { S_WEAPONSMITH, 5,
    "A unit with "
  ...
  { S_BUILDING, 3,
    ...
    "Units with this skill may also issue the BUILD command to "
    "build, repair, and maintain road segments.  One road segment "
    "requires 75 stone. Two adjacent hexes must have connecting "
    "roads to gain any benefit." },
  { S_SHIPBUILDING, 1,
    "A unit with "
  ...
  { S_FARMING, 1, 
    "A unit with " 
    "this skill may use the PRODUCE order to produce grain in " 
    "designated regions. Grain are available in most land regions." },
  { S_RANCHING, 1, 
    "A unit with "
    "this skill may use the PRODUCE order to produce livestock in "
    "designated regions. Livestock are available in most land regions." },
  { -1, -1, ""}
};
