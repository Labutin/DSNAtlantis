...
//
static GameDefs g = {
    "Standard Atlantis", // GAME_VERSION
    MAKE_ATL_VER( 4, 0, 4 ), // GAME_VERSION
...
// base price, combat, monster, walk,ride,fly,swim
    ...
    // New items
    {"pick","picks","PICK",0,
     S_WEAPONSMITH,1,I_IRON,1,1,IT_NORMAL | IT_WEAPON,
     60,1,WEAPON_PICK,0,0,0,0},
    {"spear","spears","SPEA",0,
     S_WEAPONSMITH,1,I_WOOD,1,1,IT_NORMAL | IT_WEAPON,
     60,1,WEAPON_SPEAR,0,0,0,0},
    {"axe","axes","AXE",0,
     S_WEAPONSMITH,1,I_WOOD,1,1,IT_NORMAL | IT_WEAPON,
     60,1,WEAPON_AXE,0,0,0,0},
    {"hammer","hammers","HAMM",0,
     S_WEAPONSMITH,1,I_IRON,1,1,IT_NORMAL | IT_WEAPON,
     60,1,WEAPON_HAMMER,0,0,0,0},
    {"magic crossbow","magic crossbows","MXBO",0,
     S_WEAPONSMITH,4,I_IRONWOOD,1,1,IT_ADVANCED | IT_WEAPON,
     200,1,WEAPON_MCROSSBOW,0,0,0,0},
...
/*
char* bonuses[][20] ={
  {"PICK","IRON","STON","MITH","ROOT","END"},
  {"SPEA","FUR","FLOA","END"},
  {"AXE","WOOD","IRWD","YEW","SPEA","XBOW","LBOW","MXBO","DBOW","WAGO","MWAG","GLID","SPIN","END"},
  {"HAMM","PICK","AXE","HAMM","SWOR","MSWO","CARM","PARM","MARM","END"},
  {"NET","FISH","END"},
  {"LASS","LIVE","HORS","WING","END"},
  {"BAG","HERB","GRAI","END"},
  {"SPIN","NET","LASS","LARM","CLAR","END"},
  {"END"}
};
*/
int itembonus[][20] =
{
  {I_PICK, I_IRON, I_STONE, I_MITHRIL, I_ROOTSTONE, -1},
  {I_SPEAR, I_FUR, I_FLOATER, -1},
  {I_AXE, I_WOOD, I_IRONWOOD, I_YEW, I_SPEAR, I_CROSSBOW, I_LONGBOW, I_DOUBLEBOW, I_MCROSSBOW, I_WAGON, I_MWAGON, I_GLIDER, I_SPINNING, -1},
  {I_HAMMER, I_PICK, I_AXE, I_HAMMER, I_SWORD, I_MSWORD, I_CHAINARMOR, I_PLATEARMOR, I_MPLATE, -1},
  {I_NET, I_FISH, -1},
  {I_LASSO, I_LIVESTOCK, I_HORSE, I_WHORSE, -1},
  {I_BAG, I_HERBS, I_GRAIN, -1},
  {I_SPINNING, I_NET, I_LASSO, I_LEATHERARMOR, I_CLOTHARMOR, -1},
  {-1}
};
