                              ...
                              int behind )
{
    ...
    case SPECIAL_TORNADO:
        num = def->DoAnAttack( a->special,
                               ...
                               0 );
        if (num == -1) {
            AddLine(*(a->unit->name) + " summons a wild tornado, but it is "
                    "deflected.");
        } else {
            AddLine(*(a->unit->name) + " summons a wild tornado, killing " +
                    num + ".");
        }
        break;
    ...
    case SPECIAL_SUMMON_STORM:
        num = def->DoAnAttack(a->special,
                              ...
                              EFFECT_STORM);
        if (num == -1) {
            AddLine(*(a->unit->name) + " summons a terrible storm, "
                    "but it is deflected.");
        } else {
            AddLine(*(a->unit->name) + " summons a terrible storm, "
    ...
    case SPECIAL_DISPEL_ILLUSIONS:
        num = def->DoAnAttack(a->special,
                              ...
                              SPECIAL_FLAGS,
                              0 );
        AddLine(*(a->unit->name) + " casts Dispel Illusions, dispelling " +
                num + " illusions.");
        break;
    ...
    case SPECIAL_BANISH_UNDEAD:
        num = def->DoAnAttack(a->special,
                              ...
                              SPECIAL_FLAGS,
                              0 );
        AddLine(*(a->unit->name) + " casts Banish Undead, banishing " +
                num + " undead.");
        break;
    ...
    case SPECIAL_BANISH_DEMONS:
        num = def->DoAnAttack(a->special,
                              ...
                              SPECIAL_FLAGS,
                              0 );
        AddLine(*(a->unit->name) + " casts Banish Demons, banishing " +
                num + " demons.");
        break;
    ...
    case SPECIAL_EARTHQUAKE:
        num = def->DoAnAttack(a->special,
                              ...
                              0 );
        if (num == -1) {
            AddLine(*(a->unit->name) + " invokes a mighty Earthquake, "
                    "but it is deflected.");
        } else {
            AddLine(*(a->unit->name) + " invokes a mighty Earthquake, "
                    "killing " + num + ".");
    ...
    case SPECIAL_LSTRIKE:
        ...
        num2 = def->DoAnAttack(a->special,
                               ...
                               0 );
        if (num == -1 && num2 == -1) {
            AddLine(*(a->unit->name) + " unleashes a mighty lightning "
    ...
    case SPECIAL_FIREBALL:
        num = def->DoAnAttack(a->special,
                              ...
                              0 );
        if (num == -1) {
            AddLine(*(a->unit->name) + " shoots a Fireball, but it is "
                    "deflected.");
        } else {
            AddLine(*(a->unit->name) + " shoots a Fireball, killing " +
                    num + ".");
        }
        break;
    ...
    case SPECIAL_HELLFIRE:
        num = def->DoAnAttack(a->special,
                              ...
                              0 );
        if (num == -1) {
            AddLine(*(a->unit->name) + " blasts the enemy with Hellfire, but it is "
                    "deflected.");
        } else {
            AddLine(*(a->unit->name) + " blasts the enemy with Hellfire, killing " +
                    num + ".");
        }
        break;
    ...
    case SPECIAL_CAUSEFEAR:
        num = def->DoAnAttack(a->special,
                              ...
                              EFFECT_FEAR );
        if (num == -1) {
            AddLine(*(a->unit->name) + " attempts to strike fear into the "
                    "enemy, but the spell is deflected.");
        } else {
            AddLine(*(a->unit->name) + " strikes fear into the hearts "
                    "of " + num + " men.");
        }
        break;
    ...
    case SPECIAL_BLACK_WIND:
        num = def->DoAnAttack(a->special,
                              ...
                              0 );
        if (num == -1) {
            AddLine(*(a->unit->name) + " attempts to summon the black wind, "
                    "but the spell is deflected.");
        } else {
            AddLine(*(a->unit->name) + " summons the black wind, killing " + num +
                    ".");
        }
        break;
    ...
    case SPECIAL_MINDBLAST:
        num = def->DoAnAttack(a->special,
                              ...
                              0 );
        if (num == -1) {
            AddLine(*(a->unit->name) + " attempts to blast the minds of the "
                    "enemy, but the spell is deflected.");
        } else {
            AddLine(*(a->unit->name) + " mind blasts " + num +
                    " to death.");
        }
        break;
